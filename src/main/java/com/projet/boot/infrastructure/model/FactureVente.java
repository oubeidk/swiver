...
public class FactureVente {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator= "FAC_VENTE_SEQUENCE")
	@SequenceGenerator(sequenceName = "S_FAC_VENTE", allocationSize = 1, name = "FAC_VENTE_SEQUENCE")	
	...
	public FactureVente(Long numero, Date dateFacture, Float total, String matriculeCreateur, Date dateCreation,
